...
ModelsModule::init( SLIInterpreter* )
{
  ...
  */
  ...
  kernel().model_manager.register_node_model< ht_neuron_sh >( "ht_neuron_sh" );
  kernel().model_manager.register_node_model< ht_neuron_minis >( "ht_neuron_minis" );
  kernel().model_manager.register_node_model< ht_neuron_sh_minis >( "ht_neuron_sh_minis" );
  kernel().model_manager.register_node_model< ht_neuron_sh_minis_INaPth >( "ht_neuron_sh_minis_INaPth" );
